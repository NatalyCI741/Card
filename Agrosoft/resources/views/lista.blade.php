        ...
        <div class="modal-content">
            <form id="formEditar" action="{{ route('cultivos.update', 0) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="edit-nombre" class="form-label">Nombre del cultivo</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="formEliminar" action="" method="POST">
                ...
                @method('DELETE')
                <div class="modal-header">
                    <h5 class="modal-title" id="eliminarLabel">Eliminar cultivo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.editbtn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('formEditar').action = "{{ url('cultivos') }}/" + id; // Aquí corregimos la construcción de la URL
        ...
        document.querySelectorAll('.deletebtn').forEach(button => {
            button.addEventListener('click', function() {
                const id = this.getAttribute('data-id');
                document.getElementById('formEliminar').action = "{{ url('cultivos') }}/" + id; // Aquí también corregimos la construcción de la URL
                document.getElementById('delete-id').value = id; // Esto es opcional
            });
        });
    });
</script>
